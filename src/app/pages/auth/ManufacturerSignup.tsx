...
import { ArrowLeft, Building2, Upload, CheckCircle2, FileText, MapPin, Hash, Mail } from 'lucide-react';
...
export default function ManufacturerSignup() {
  ...
  const handleVerifyOtp = async () => {
    ...
    try {
      ...
      profileData.append('cacNumber', formData.cacNumber);
      profileData.append('tinNumber', formData.tinNumber);
      ...
      <Card className="max-w-2xl w-full p-8">
          ...
          <form onSubmit={handleStep1Submit} className="space-y-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                <Input id="companyName" name="companyName" type="text" value={formData.companyName} onChange={handleInputChange} placeholder="Enter your company name" required />
              </div>
              <div>
                <Label htmlFor="email">Business Email *</Label>
                <Input id="email" name="email" type="email" value={formData.email} onChange={handleInputChange} placeholder="company@example.com" required />
              </div>
              <div>
              ...
              <div>
                ...
                <Input id="password" name="password" type="password" value={formData.password} onChange={handleInputChange} placeholder="Minimum 8 characters, include uppercase, lowercase and number" required />
              </div>
              <div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="relative">
                  ...
                  <Input id="cacNumber" name="cacNumber" type="text" value={formData.cacNumber} onChange={handleInputChange} placeholder="RC123456" className="pl-10" required />
                </div>
              ...
              <div>
                ...
                <div className="relative">
                  <Hash className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400" />
                  <Input id="tinNumber" name="tinNumber" type="text" value={formData.tinNumber} onChange={handleInputChange} placeholder="12345678-0001" className="pl-10" required />
                </div>
              </div>
              <div>
                ...
                <div className="relative">
                  ...
                  <Input id="address" name="address" type="text" value={formData.address} onChange={handleInputChange} placeholder="123 Business Street, Lagos, Nigeria" className="pl-10" required />
                </div>
              </div>
            </div>
        ...
        {step === 3 && (
          <form onSubmit={handleStep3Submit} className="space-y-6">
            ...
            <div className="space-y-4">
              {[
                { key: 'cacDocument', label: 'CAC Certificate *', prompt: 'Upload CAC certificate' },
                { key: 'tinDocument', label: 'TIN Certificate *', prompt: 'Upload TIN certificate' },
                { key: 'proofOfAddress', label: 'Proof of Business Address *', prompt: 'Upload utility bill or lease agreement' },
